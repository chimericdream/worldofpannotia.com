      ...
      def render(context)
        ...
        site.collections["domains"].docs.each do |domain|
          if @domain_slug == domain.basename_without_ext
            ...
            return <<-MARKUP.strip
              <a href="#{domain.url}" title="#{domain.data["title"]} Domain"><em>#{title}</em></a>
            MARKUP
          end
        end
      ...
      def render(context)
        ...
        site.collections["epic_spells"].docs.each do |epic_spell|
          if @epic_spell_slug == epic_spell.basename_without_ext
            ...
            return <<-MARKUP.strip
              <a href="#{epic_spell.url}" title="#{epic_spell.data["title"]}"><em>#{title}</em></a>
            MARKUP
          end
        end
      ...
      def render(context)
        ...
        site.collections["feats"].docs.each do |feat|
          if @feat_slug == feat.basename_without_ext
            ...
            return <<-MARKUP.strip
              <a href="#{feat.url}" title="#{feat.data["title"]}"><em>#{title}</em></a>
            MARKUP
          end
        end
      ...
      def render(context)
        ...
        site.collections["skills"].docs.each do |skill|
          if @skill_slug == skill.basename_without_ext
            ...
            return <<-MARKUP.strip
              <a href="#{skill.url}" title="#{skill.data["title"]}"><em>#{title}</em></a>
            MARKUP
          end
        end
      ...
      def render(context)
        ...
        site.collections["spells"].docs.each do |spell|
          if @spell_slug == spell.basename_without_ext
            ...
            return <<-MARKUP.strip
              <a href="#{spell.url}" title="#{spell.data["title"]}"><em>#{title}</em></a>
            MARKUP
          end
        end
