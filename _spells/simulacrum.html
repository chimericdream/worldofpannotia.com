...
spell:
  ...
  savingThrow:        "None"
  spellResistance:    "No"
  materialComponents: ["The spell is cast over the rough snow or ice form, and some piece of the creature to be duplicated (hair, nail, or the like) must be placed inside the snow or ice. Additionally, the spell requires powdered ruby worth 100 gp per HD of the simulacrum to be created."]
  xpCostSpecial:      "100 XP per HD of the simulacrum to be created (minimum 1,000 XP)."
  description:        |
