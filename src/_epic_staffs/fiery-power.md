...
item:
  ...
  casterLevel: "25th"
  prerequisites:
    feats: ["{% feat_link craft-staff %}", "{% epic_feat_link craft-epic-staff %}", "{% feat_link extend-spell %}", "{% feat_link heighten-spell %}", "{% epic_feat_link improved-heighten-spell %}", "{% epic_feat_link intensify-spell %}", "{% feat_link spell-focus 'Spell Focus (Evocation)' %}"]
    spells: ["{% spell_link continual-flame %}", "{% spell_link delayed-blast-fireball %}", "{% spell_link meteor-swarm %}", "{% spell_link protection-from-energy %}", "{% spell_link summon-monster-ix %}", "{% spell_link wall-of-fire %}"]
    special: []
  marketPrice: 500000
  marketPriceSpecial: ""
  costToCreate:
