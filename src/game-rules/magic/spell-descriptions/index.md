...
Accompanying the spell name is a line giving the school of magic (and the subschool, if appropriate) that the spell belongs to.
...
Appearing along with the school and subschool, when applicable, is a descriptor that further categorizes the spell in some way. Some spells have more than one descriptor.
...
{: #magical-attacks-vs-items-table .table .table-bordered .table-hover .table-striped data-caption="Table: Items Affected by Magical Attacks" }
